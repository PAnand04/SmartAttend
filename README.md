# SmartAttend – AI Powered Attendance System (Team Project)

This repository is a fork of the original team project developed as part of our academic work.
...
Python (Flask) • SQL (SQLite) • API Integration • Backend Logic

For full project details, refer to the original repository README below.
